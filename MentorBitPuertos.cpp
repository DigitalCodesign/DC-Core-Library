    ...
    */
    void MentorBitPuertos::conectar(uint8_t port, MentorPort& module) {
        ...
        switch (port)
        {
            ...
            case MentorBitPuertos::PUERTO_MODULO_3:
                module_port.type = 'm';
                module_port.location = port;
                module_port.gpios[0] = MentorBitPuertos::PUERTO_MODULO_3_ANALOGICO;
                module_port.gpios[1] = MentorBitPuertos::PUERTO_MODULO_3_DIGITAL;
                module.configPort(module_port);
                break;
